...
A request (`req`) is an environment with the data sent from a web browser to the web server. A [Job](jobqueue::Job) (`job`) is an R6 object containing a single `req` along with the parameters for processing it.
